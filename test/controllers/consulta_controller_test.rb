...
class ConsultaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consultum" do
    assert_difference('Consultum.count') do
      post consulta_url, params: { consultum: { created_at: @consultum.created_at, data: @consultum.data, deleted_at: @consultum.deleted_at, prescricao: @consultum.prescricao, sintomas: @consultum.sintomas } }
    end
  ...
  test "should update consultum" do
    patch consultum_url(@consultum), params: { consultum: { created_at: @consultum.created_at, data: @consultum.data, deleted_at: @consultum.deleted_at, prescricao: @consultum.prescricao, sintomas: @consultum.sintomas } }
